...
const SLAPolicyPage: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      // Note: Service catalog integration is not yet implemented
      // When service catalog endpoints are available, they can be added here
      setServiceCatalogs([]);
      setServiceItems([]);
          ...
          <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div className="mt-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {formData.serviceCatalogId && serviceItems.length > 0 && (
                  <div>
                ...
                {serviceCatalogs.length === 0 && (
                  <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
                    <p className="text-sm text-blue-700">
                      <strong>Note:</strong> Service catalog integration is not yet implemented. SLA policies currently apply based on Supporting Group and Priority. Service-specific SLA policies will be available in a future update.
                    </p>
                  </div>
                )}
