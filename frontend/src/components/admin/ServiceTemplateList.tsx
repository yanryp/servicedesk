...
const ServiceTemplateList: React.FC<ServiceTemplateListProps> = ({ 
  ...
  const loadServiceItems = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`/api/service-catalog-admin/catalogs/${selectedCatalog.id}/items`, {
        headers: {
  ...
  const loadTemplates = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`/api/service-catalog-admin/items/${selectedServiceItem.id}/templates`, {
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
      });
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/service-catalog-admin/templates/${showDeleteConfirm.id}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${localStorage.getItem('token')}`
        }
...
const ServiceTemplateEditor: React.FC<ServiceTemplateEditorProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = isEditing 
        ? `/api/service-catalog-admin/templates/${template.id}`
        : `/api/service-catalog-admin/items/${serviceItemId}/templates`;
