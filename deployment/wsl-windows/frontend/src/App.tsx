      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-auto">
          <Routes>
            ...
            <Route path="/service-catalog" element={<div className="container mx-auto p-6 max-w-7xl"><ServiceCatalogPage /></div>} />
            <Route path="/service-catalog-v2" element={<div className="container mx-auto p-6 max-w-7xl"><ServiceCatalogV2Page /></div>} />
            <Route path="/service-catalog-admin" element={<ProtectedRoute roles={['admin', 'manager']}><div className="container mx-auto p-6 max-w-7xl"><ServiceCatalogAdminPage /></div></ProtectedRoute>} />
            <Route path="/tickets/:ticketId" element={<div className="container mx-auto p-6 max-w-7xl"><TicketDetailPage /></div>} />
            <Route path="/tickets/:ticketId/edit" element={<div className="container mx-auto p-6 max-w-7xl"><EditTicketPage /></div>} />
            ...
            <Route path="/categorization/queue" element={<ProtectedRoute roles={['admin', 'manager', 'technician']}><div className="container mx-auto p-6 max-w-7xl"><UncategorizedTicketsPage /></div></ProtectedRoute>} />
